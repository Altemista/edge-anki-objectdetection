...
def test_left_lane_2():
    cube_detector = CubeDetector()
    frame = cv2.imread("../anki_object_detection/images/cube_left_lane_2.jpg")
...
def test_left_lane_3():
    cube_detector = CubeDetector()
    frame = cv2.imread("../anki_object_detection/images/cube_left_lane_3.jpg")
    ...
    assert -1 == horizontal_lane
    assert 3 == vertical_lane



def test_left_lane_4():
    cube_detector = CubeDetector()
    frame = cv2.imread("../anki_object_detection/images/cube_left_lane_4.jpg")
