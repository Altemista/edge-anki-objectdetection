...
def test_middle_lane_1():
    cube_detector = CubeDetector()
    frame = cv2.imread("../anki_object_detection/images/cube_middle_lane_1.jpg")
    ...
    assert 2 == vertical_lane


def test_middle_lane_2():
    cube_detector = CubeDetector()
    frame = cv2.imread("../anki_object_detection/images/cube_middle_lane_2.jpg")
...
def test_middle_lane_3():
    cube_detector = CubeDetector()
    frame = cv2.imread("../anki_object_detection/images/cube_middle_lane_3.jpg")
...
def test_middle_lane_4():
    cube_detector = CubeDetector()
    frame = cv2.imread("../anki_object_detection/images/cube_middle_lane_4.jpg")
