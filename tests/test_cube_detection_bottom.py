...
def test_bottom_lane_1():
    ...
    frame = cv2.imread("../anki_object_detection/images/cube_bottom_lane_1.jpg")
...
def test_bottom_lane_2():
    cube_detector = CubeDetector()
    frame = cv2.imread("../anki_object_detection/images/cube_bottom_lane_2.jpg")
...
def test_bottom_lane_3():
    cube_detector = CubeDetector()
    frame = cv2.imread("../anki_object_detection/images/cube_bottom_lane_3.jpg")
...
def test_bottom_lane_4():
    cube_detector = CubeDetector()
    frame = cv2.imread("../anki_object_detection/images/cube_bottom_lane_4.jpg")
